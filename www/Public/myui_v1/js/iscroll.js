                ...
                if (hasTouch) {
                    if (that.doubleTapTimer && that.options.zoom) {
                        ...
                        that.doubleTapTimer = setTimeout(function () {
                            ...
                            //alert(ua);
                            if (ua.match(/; mi/i) == "; mi" || ua.match(/; huawei/i) == "; huawei" || ua.match(/; m040/i) == "; m040" || ua.match(/; zte/i) == "; zte" || ua.match(/; m356/i) == "; m356" || ua.match(/; sm-n900t/i) == "; sm-n900t") {
                                isTagNameOk = false;
                            }
                            if (ua.match(/; huawei t8950/i) == "; huawei t8950") {
                                isTagNameOk = true;
                            }
