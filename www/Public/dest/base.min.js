...
/*** User: yaotaiyang *åˆ©ç”¨ | åˆ†å‰²æ¯ä¸ªhashå€¼ mysoft.com.cn#abc=1|bcd=2|edf=3**/
...
/**user:taizhao,å­˜å‚¨localstorageï¼Œå¯ä»¥é€‰æ‹©è¿‡æœŸæ—¶é—´**/
...
/**cookieæ“ä½œ User:lizz*/
(function(a){a.extend(a,{cookie:function(d,e,c){var h,g,b,f;if(arguments.length>1&&String(e)!=="[object Object]"){c=a.extend({},c);if(e===null||e===undefined){c.expires=-1}if(typeof c.expires==="number"){h=(c.expires*24*60*60*1000);g=c.expires=new Date();g.setTime(g.getTime()+h)}e=String(e);return(document.cookie=[encodeURIComponent(d),"=",c.raw?e:encodeURIComponent(e),c.expires?"; expires="+c.expires.toUTCString():"",c.path?"; path="+c.path:"",c.domain?"; domain="+c.domain:"",c.secure?"; secure":""].join(""))}c=e||{};f=c.raw?function(i){return i}:decodeURIComponent;return(b=new RegExp("(?:^|; )"+encodeURIComponent(d)+"=([^;]*)").exec(document.cookie))?f(b[1]):null},removeCookie:function(c,b){if(a.cookie(c)===undefined){return false}a.cookie(c,"",a.extend({},b,{expires:-1}));return !a.cookie(c)}})})(Zepto);
/**å‰ç«¯å­˜å‚¨ User:lizz*/
Zepto.storage={};(function(a){a.extend(a.storage,{getItem:function(b){if(localStorage){return localStorage.getItem(b)}else{return a.cookie(b)}},removeItem:function(b){if(localStorage){localStorage.removeItem(b)}else{a.removeCookie(b)}},setItem:function(b,c){if(localStorage){localStorage.setItem(b,c,{expires:360})}else{a.cookie(b,c)}}})})(Zepto);